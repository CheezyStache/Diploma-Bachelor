...
namespace Diploma_WebControllerAPI.DataGenerator
{
    public class TripGenerator
    {
        public bool Generate()
        {
            ...
            trips.Add(new Trip { Id = 1, Time = TimeSpan.FromMinutes(43).Ticks‬, Date = DateTime.Parse("4/5/2020 12:15:12 PM"), PetrolAmount = 14, InProgress = false, UtilityId = 1 });
            ...
            trips.Add(new Trip { Id = 2, Time = TimeSpan.FromMinutes(42).Ticks‬, Date = DateTime.Parse("4/6/2020 12:48:12 PM"), PetrolAmount = 10, InProgress = false, UtilityId = 1 });
            ...
            trips.Add(new Trip { Id = 3, Time = TimeSpan.FromMinutes(50).Ticks‬, Date = DateTime.Parse("4/6/2020 12:59:12 PM"), PetrolAmount = 21, InProgress = false, UtilityId = 1 });
            ...
            trips.Add(new Trip { Id = 4, Date = DateTime.Parse("4/7/2020 13:14:12 PM"), InProgress = true, UtilityId = 1 });
            ...
            trips.Add(new Trip { Id = 5, Time = TimeSpan.FromMinutes(56).Ticks‬, Date = DateTime.Parse("4/7/2020 11:26:12 PM"), PetrolAmount = 10, InProgress = false, UtilityId = 2 });
            ...
            trips.Add(new Trip { Id = 6, Time = TimeSpan.FromMinutes(41).Ticks‬, Date = DateTime.Parse("4/8/2020 17:54:12 PM"), PetrolAmount = 23, InProgress = false, UtilityId = 2 });
            ...
            trips.Add(new Trip { Id = 7, Time = TimeSpan.FromMinutes(49).Ticks‬, Date = DateTime.Parse("4/9/2020 15:15:12 PM"), PetrolAmount = 14, InProgress = false, UtilityId = 3 });
            ...
            trips.Add(new Trip { Id = 8, Time = TimeSpan.FromMinutes(74).Ticks‬, Date = DateTime.Parse("4/10/2020 19:15:12 PM"), PetrolAmount = 15, InProgress = false, UtilityId = 3 });
            tripContainers.Add(new TripContainers { Id = 22, TripId = 8, ContainerId = 8 });

            trips.Add(new Trip { Id = 9, Time = TimeSpan.FromMinutes(36).Ticks‬, Date = DateTime.Parse("4/10/2020 13:05:12 PM"), PetrolAmount = 10, InProgress = false, UtilityId = 4 });
            ...
            trips.Add(new Trip { Id = 10, Time = TimeSpan.FromMinutes(65).Ticks‬, Date = DateTime.Parse("4/11/2020 18:45:12 PM"), PetrolAmount = 19, InProgress = false, UtilityId = 4 });
            tripContainers.Add(new TripContainers { Id = 26, TripId = 10, ContainerId = 10 });

            trips.Add(new Trip { Id = 11, Time = TimeSpan.FromMinutes(46).Ticks‬, Date = DateTime.Parse("4/12/2020 08:34:12 PM"), PetrolAmount = 9, InProgress = false, UtilityId = 4 });
            ...
            trips.Add(new Trip { Id = 12, Time = TimeSpan.FromMinutes(49).Ticks‬, Date = DateTime.Parse("4/12/2020 16:15:12 PM"), PetrolAmount = 11, InProgress = false, UtilityId = 5 });
            ...
            trips.Add(new Trip { Id = 13, Date = DateTime.Parse("4/15/2020 17:23:12 PM"), InProgress = true, UtilityId = 5 });
            tripContainers.Add(new TripContainers { Id = 32, TripId = 13, ContainerId = 14 });

            trips.Add(new Trip { Id = 14, Time = TimeSpan.FromMinutes(79).Ticks‬, Date = DateTime.Parse("4/16/2020 12:18:12 PM"), PetrolAmount = 15, InProgress = false, UtilityId = 6 });
            tripContainers.Add(new TripContainers { Id = 33, TripId = 14, ContainerId = 15 });

            trips.Add(new Trip { Id = 15, Time = TimeSpan.FromMinutes(58).Ticks‬, Date = DateTime.Parse("4/17/2020 12:46:12 PM"), PetrolAmount = 12, InProgress = false, UtilityId = 6 });
            ...
            trips.Add(new Trip { Id = 16, Time = TimeSpan.FromMinutes(72).Ticks‬, Date = DateTime.Parse("4/18/2020 11:26:12 PM"), PetrolAmount = 11, InProgress = false, UtilityId = 7 });
